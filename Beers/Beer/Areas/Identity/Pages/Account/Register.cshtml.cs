        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.OfficeUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.OfficeUser));
                    }

                    if(role == SD.OfficeUser)
                    {
                        await _userManager.AddToRoleAsync(user, SD.OfficeUser);
                    }
                    else
                    {
